...
func CreateCycle(
	...
	storage.LatestGapMs = gapMs

	storage.LatestServerTime =
		now.Format(
			"2006-01-02 15:04:05.000",
		)

	storage.LatestHandlerDurationUs =
		handlerDurationUs
	...
	json.NewEncoder(w).Encode(
		map[string]any{
			...
			"cycle_time_sec": req.CycleTimeSec,

			"production_count": req.ProductionCount,
			...
			"gap_sec": float64(gapMs) / 1000,

			"handler_duration_us": handlerDurationUs,
		},
	)
}
